...
TRUST_REMOTE_CODE = False  # Não é necessário para o GPT-2
...
def load_model_and_tokenizer(device: str):
    ...
    # GPT-2 não tem pad_token definido: usamos eos_token como pad
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Benchmark energético do modelo GPT-2 (openai-community/gpt2)."
    )
    parser.add_argument(
        "--queries_path",
        type=str,
...
def main():
    ...
    print("=== BENCHMARK ENERGÉTICO - GPT-2 (openai-community/gpt2) ===")
