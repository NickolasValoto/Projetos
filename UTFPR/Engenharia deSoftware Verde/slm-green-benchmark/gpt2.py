...
# Modelo GPT local (baseline pequeno)
MODEL_NAME = "gpt2"  # você pode trocar por outro modelo GPT compatível com transformers
DEVICE = "cpu"
QUERIES_FILE = "data/queries.txt"
RESULTS_FILE = "results/environmental_data_gpt2_baseline.json"
...
# Fonte aproximada: relatórios de intensidade de carbono da matriz elétrica brasileira (~0,1295 kg CO2/kWh)
